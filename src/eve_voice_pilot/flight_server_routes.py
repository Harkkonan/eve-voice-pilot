...
FLIGHT_GET_ROUTE_METHODS: dict[str, str] = {
    ...
    "/api/flight/personal-core": "_handle_flight_personal_core",
    ...
    "/api/flight/acquisition/compare": "_handle_flight_acquisition_compare",
    "/api/flight/acquisition/progress": "_handle_flight_acquisition_progress",
    "/api/flight/acquisition/compare/progress": "_handle_flight_acquisition_compare_progress",
