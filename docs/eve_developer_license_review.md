...
- 2026-06-06: Re-opened the official EVE Developer License Agreement, developer license docs, and EVE third-party policy page before adding the Intel Pet Voice Lab command editor. The editor saves local personal command-profile changes, keeps dry-run phrase tests from sending keys, preserves exact-match command behavior, and does not add multi-step automation, input broadcasting, OCR decisions, or automatic gameplay reactions.
...
- 2026-06-06: Re-opened the official EVE Developer License Agreement, developer license docs, and EVE third-party policy page before adding Intel Pet Phrase Trainer. The feature keeps recent heard voice phrases in memory only for the current pet run, requires a manual click to add a phrase to a selected local command, preserves exact-match command behavior, and does not add fuzzy automation, input broadcasting, OCR decisions, or automatic gameplay reactions.
